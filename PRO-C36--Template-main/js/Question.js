class Question {
  ...
  constructor() {
    ...
    this.input2 = createInput("Enter the correct answers number..");
  ...
  display(){
    ...
    this.title.html("What is my favourite sport?");
    ...
    this.option1.html("1: Soccer " );
    this.option1.position(150, 100);
    this.option2.html("2: Basketball" );
    this.option2.position(150, 120);
    this.option3.html("3: Cricket " );
    this.option3.position(150, 140);
    this.option4.html("4: Hockey" );
